...
.. code:: bash
	...
	make PLAT=g3e BOARD=dev_1 BL33=${path_to_u-boot_file}/u-boot.bin bl2 fip bptool pkg
	make PLAT=g3e BOARD=smarc BL33=${path_to_u-boot_file}/u-boot.bin bl2 fip bptool pkg
