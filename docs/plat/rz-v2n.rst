...
The current TF-A port has been tested on the Development and Evaluation Alpha RZ/V2N platforms.
...
* u-boot:
  <URL TBD> - The port has been tested using mainline uboot with the appropriate dev_1 RZ/V2N board specific patches.
  <URL TBD>
...
.. code:: bash
	...
	make PLAT=v2n all BOARD=dev_1 ENABLE_STACK_PROTECTOR=all LOG_LEVEL=40
	make PLAT=v2n all BOARD=dev_1 ENABLE_STACK_PROTECTOR=all DEBUG=1 LOG_LEVEL=40
...
::
	...
	NOTICE:  BL2: v2.7(release):v2.7/rzv2n-1.00-2312-ga552b0f46
	NOTICE:  BL2: Built : 12:43:11, Dec 17 2023
	NOTICE:  BL2: Booting BL31
	NOTICE:  BL31: v2.7(release):v2.7/rzv2n-1.00-2312-ga552b0f46
	...
	Model: Renesas EVK Alpha based on r9a09g056h4
	DRAM:  15.9 GiB
