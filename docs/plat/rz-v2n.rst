...
.. code:: bash
	...
	make PLAT=v2n BOARD=dev_1 ENABLE_STACK_PROTECTOR=all BL33=${path_to_u-boot_file}/u-boot.bin bl2 fip bptool pkg
	make PLAT=v2n BOARD=evk_1 ENABLE_STACK_PROTECTOR=all BL33=${path_to_u-boot_file}/u-boot.bin bl2 fip bptool pkg
