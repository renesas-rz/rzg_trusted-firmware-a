...
When building TF-A , the correct BOARD option must be selected.
What follows is shows the builds for the Evaluation 1 and Evaluation 2 RZ/V2H development kit.
