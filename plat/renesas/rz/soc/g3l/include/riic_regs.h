...
#define RIIC_ICSARL0	((uintptr_t)RIIC_BASE + 0x0A)
#define RIIC_ICSARL1	((uintptr_t)RIIC_BASE + 0x0C)
#define RIIC_ICSARL2	((uintptr_t)RIIC_BASE + 0x0E)
#define RIIC_ICSARU0	((uintptr_t)RIIC_BASE + 0x0B)
#define RIIC_ICSARU1	((uintptr_t)RIIC_BASE + 0x0D)
#define RIIC_ICSARU2	((uintptr_t)RIIC_BASE + 0x0F)
