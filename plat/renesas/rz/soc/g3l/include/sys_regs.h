...
#define SYS_PCIE_ERR_MON					(SYS_BASE + 0x000003AC)
#define SYS_PCIE_PHY_CFG					(SYS_BASE + 0x000003B4)
...
#define SYS_CA55_CFG_RVAL0					(SYS_BASE + 0x00000810)
#define SYS_CA55_CFG_RVAH0					(SYS_BASE + 0x00000814)

#define SYS_CA55_CFG_RVAL1					(SYS_BASE + 0x00000818)
#define SYS_CA55_CFG_RVAH1					(SYS_BASE + 0x0000081C)

#define SYS_CA55_CFG_RVAL2					(SYS_BASE + 0x00000820)
#define SYS_CA55_CFG_RVAH2					(SYS_BASE + 0x00000824)

#define SYS_CA55_CFG_RVAL3					(SYS_BASE + 0x00000828)
#define SYS_CA55_CFG_RVAH3					(SYS_BASE + 0x0000082C)

#define SYS_CM33_CFG0						(SYS_BASE + 0x00000864)
#define SYS_CM33_CFG1						(SYS_BASE + 0x00000868)
#define SYS_CM33_CFG2						(SYS_BASE + 0x0000086C)
#define SYS_CM33_CFG3						(SYS_BASE + 0x00000870)
#define SYS_CM33_LOCK						(SYS_BASE + 0x00000874)
...
#define SYS_LP_CTL1_CA55SLEEP_REQ			(0x00000100UL)
#define SYS_LP_CTL1_CA55SLEEP_REQ_MSK		(0x00000F00UL)
#define SYS_LP_CTL1_CA55SLEEP_ACK			(0x01000000UL)
#define SYS_LP_CTL1_CA55SLEEP_ACK_MSK		(0x0F000000UL)

#define SYS_LP_CTL2_CA55_STBYCTL			(0x00000001UL)
...
#define MSTACCCTL0_GPU_ARPU					(1 << 20)
#define MSTACCCTL0_GPU_ARNS					(1 << 21)
#define MSTACCCTL0_GPU_ARSEL				(1 << 22)
...
#define MSTACCCTL2_USB2_1D_AWPU				(1 << 24)
#define MSTACCCTL2_USB2_1D_AWNS				(1 << 25)
#define MSTACCCTL2_USB2_1D_AWSEL			(1 << 27)
#define MSTACCCTL2_USB2_1D_ARPU				(1 << 28)
#define MSTACCCTL2_USB2_1D_ARNS				(1 << 29)
#define MSTACCCTL2_USB2_1D_ARSEL			(1 << 31)

#define MSTACCCTL3_H264_AWPU				(1 << 0)
#define MSTACCCTL3_H264_AWNS				(1 << 1)
#define MSTACCCTL3_H264_AWSEL				(1 << 3)
#define MSTACCCTL3_H264_ARPU				(1 << 4)
...
#define MSTACCCTL3_LCDC_ARPU				(1 << 12)
...
#define MSTACCCTL3_DSI_ARPU					(1 << 20)
#define MSTACCCTL3_DSI_ARNS					(1 << 21)
#define MSTACCCTL3_DSI_ARSEL				(1 << 23)

#define MSTACCCTL4_SDHI2_AWPU				(1 << 0)
#define MSTACCCTL4_SDHI2_AWNS				(1 << 1)
#define MSTACCCTL4_SDHI2_AWSEL				(1 << 3)
#define MSTACCCTL4_SDHI2_ARPU				(1 << 4)
#define MSTACCCTL4_SDHI2_ARNS				(1 << 5)
#define MSTACCCTL4_SDHI2_ARSEL				(1 << 7)
...
#define SLVACCCTL3_GPU_SL_00				(0 << 16)
#define SLVACCCTL3_GPU_SL_01				(1 << 16)
#define SLVACCCTL3_GPU_SL_10				(2 << 16)
#define SLVACCCTL3_GPU_SL_11				(3 << 16)
#define SLVACCCTL3_H264_SL_00				(0 << 18)
#define SLVACCCTL3_H264_SL_01				(1 << 18)
#define SLVACCCTL3_H264_SL_10				(2 << 18)
#define SLVACCCTL3_H264_SL_11				(3 << 18)
#define SLVACCCTL3_CRU_SL_00				(0 << 20)
#define SLVACCCTL3_CRU_SL_01				(1 << 20)
#define SLVACCCTL3_CRU_SL_10				(2 << 20)
#define SLVACCCTL3_CRU_SL_11				(3 << 20)
#define SLVACCCTL3_ISU_SL_00				(0 << 22)
#define SLVACCCTL3_ISU_SL_01				(1 << 22)
#define SLVACCCTL3_ISU_SL_10				(2 << 22)
#define SLVACCCTL3_ISU_SL_11				(3 << 22)
#define SLVACCCTL3_DSIPHY_SL_00				(0 << 24)
#define SLVACCCTL3_DSIPHY_SL_01				(1 << 24)
#define SLVACCCTL3_DSIPHY_SL_10				(2 << 24)
#define SLVACCCTL3_DSIPHY_SL_11				(3 << 24)
#define SLVACCCTL3_DSILINK_SL_00			(0 << 26)
#define SLVACCCTL3_DSILINK_SL_01			(1 << 26)
#define SLVACCCTL3_DSILINK_SL_10			(2 << 26)
#define SLVACCCTL3_DSILINK_SL_11			(3 << 26)
#define SLVACCCTL3_LCDC_SL_00				(0 << 28)
#define SLVACCCTL3_LCDC_SL_01				(1 << 28)
#define SLVACCCTL3_LCDC_SL_10				(2 << 28)
#define SLVACCCTL3_LCDC_SL_11				(3 << 28)
...
#define SLVACCCTL8_RSCI0_SL_00				(0 << 18)
#define SLVACCCTL8_RSCI0_SL_01				(1 << 18)
#define SLVACCCTL8_RSCI0_SL_10				(2 << 18)
#define SLVACCCTL8_RSCI0_SL_11				(3 << 18)
#define SLVACCCTL8_RSCI1_SL_00				(0 << 20)
#define SLVACCCTL8_RSCI1_SL_01				(1 << 20)
#define SLVACCCTL8_RSCI1_SL_10				(2 << 20)
#define SLVACCCTL8_RSCI1_SL_11				(3 << 20)
#define SLVACCCTL8_RSCI2_SL_00				(0 << 22)
#define SLVACCCTL8_RSCI2_SL_01				(1 << 22)
#define SLVACCCTL8_RSCI2_SL_10				(2 << 22)
#define SLVACCCTL8_RSCI2_SL_11				(3 << 22)
#define SLVACCCTL8_RSCI3_SL_00				(0 << 24)
#define SLVACCCTL8_RSCI3_SL_01				(1 << 24)
#define SLVACCCTL8_RSCI3_SL_10				(2 << 24)
#define SLVACCCTL8_RSCI3_SL_11				(3 << 24)
...
#define SLVACCCTL11_BSC_SL_00				(0 << 12)
#define SLVACCCTL11_BSC_SL_01				(1 << 12)
#define SLVACCCTL11_BSC_SL_10				(2 << 12)
#define SLVACCCTL11_BSC_SL_11				(3 << 12)
...
#define DDR_MCAR_CTRL_MCARSTOP				(1 << 16)

#define GETH0_CFG_1G_MAC_SPEED				(0 << 4)
#define GETH0_CFG_2G5_MAC_SPEED				(1 << 4)
#define GETH0_CFG_10M_MAC_SPEED				(3 << 4)
#define GETH0_CFG_100M_MAC_SPEED			(4 << 4)

#define GETH1_CFG_1G_MAC_SPEED				(0 << 4)
#define GETH1_CFG_2G5_MAC_SPEED				(1 << 4)
#define GETH1_CFG_10M_MAC_SPEED				(3 << 4)
#define GETH1_CFG_100M_MAC_SPEED			(4 << 4)

#define PCIE_CFG_ALLOW_ENTER_L1				(1 << 8)

#define PCIE_MON_PMU_POWEROFF				(1 << 0)
#define PCIE_MON_CLKL1PM_REQ				(1 << 1)
#define PCIE_MON_D_STATE_OUT_F0_D0			(0 << 4)
#define PCIE_MON_D_STATE_OUT_F0_D1			(1 << 4)
#define PCIE_MON_D_STATE_OUT_F0_D2			(2 << 4)
#define PCIE_MON_D_STATE_OUT_F0_D3			(3 << 4)

#define PCIE_ERR_MON_COR_DETECTED_F0		(1 << 0)
#define PCIE_ERR_MON_NONFATAL_DETECTED_F0	(1 << 1)
#define PCIE_ERR_MON_FATAL_DETECTED_F0		(1 << 2)

#define PCIE_PHY_MODE_RXTERMINATION			(1 << 0)
...
#define LSI_MODE_STAT_SEC_EN				(1 << 16)
