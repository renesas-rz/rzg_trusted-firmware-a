...
#define RZV2N_AUTH_API_BASE         UL(0x00014300)
#define RZV2N_BOOT_RAM_BASE			UL(0x07F80000)
#define RZV2N_SRAM0_BASE			UL(0x08000000)
#define RZV2N_SRAM1_BASE			UL(0x08080000)
...
#define RZV2N_TZC400_SRAM_0_1		UL(0x10460000)		/* MCPU Bus */
...
#define RZV2N_TZC400_SRAM_2			UL(0x13CB0000)		/* ACPU Bus */
...
#define RZV2N_BOOT_RAM_SIZE			(0x00001000)
#define RZV2N_MSRAM_SIZE			(RZV2N_SRAM_SIZE*2)
#define RZV2N_ASRAM_SIZE			RZV2N_SRAM_SIZE
#define RZV2N_SRAM_TOTAL_SIZE		(RZV2N_MSRAM_SIZE + RZV2N_ASRAM_SIZE)
 ...
 ************************/
#define RZV2N_NV_SIZE_MAX			UL(0x00300000) /* eSD boot = 6144 sectors. 6144 x 512bytes = 0x300000. */
#define RZV2N_BL2_SIZE_MAX			UL(0x00060000)
#define RZV2N_FIP_SIZE_MAX			UL(0x001A0000)
#define RZV2N_M33_FW_SIZE			UL(0x00030000)
#define RZV2N_DDR_CFG_SIZE_MAX		UL(0x00001000)

#if BOOT_TFA_USING_CM33
#define RZV2N_FIP_OFFSET			UL(0x00280000)
#else
#define RZV2N_FIP_OFFSET			RZV2N_BL2_SIZE_MAX
#endif /* BOOT_TFA_USING_CM33 */

#define RZV2N_SPIROM_FIP_BASE		RZV2N_XSPI_MEMORY_MAP_BASE + RZV2N_FIP_OFFSET

#define RZV2N_EMMC_FIP_BASE			RZV2N_FIP_OFFSET

#define RZV2N_SD_FIP_BASE			RZV2N_FIP_OFFSET

#define RZV2N_M33_FW_OFFSET				UL(0x00200000)
#define RZV2N_SPIROM_M33_FW_BASE		(RZV2N_XSPI_MEMORY_MAP_BASE + RZV2N_M33_FW_OFFSET)
#define RZV2N_EMMC_M33_FW_BASE			RZV2N_M33_FW_OFFSET
#define RZV2N_SD_M33_FW_BASE			RZV2N_M33_FW_OFFSET

#define RZV2N_SPIROM_DDR_CFG_OFFSET		(RZV2N_M33_FW_OFFSET + RZV2N_M33_FW_SIZE)
#define RZV2N_SPIROM_DDR_CFG_BASE		(RZV2N_XSPI_MEMORY_MAP_BASE + RZV2N_SPIROM_DDR_CFG_OFFSET)
#define RZV2N_EMMC_DDR_CFG_BASE			RZV2N_SPIROM_DDR_CFG_OFFSET
#define RZV2N_SD_DDR_CFG_BASE			RZV2N_SPIROM_DDR_CFG_OFFSET

#if BOOT_TFA_USING_CM33

#if ((RZV2N_SPIROM_DDR_CFG_OFFSET + RZV2N_DDR_CFG_SIZE_MAX) >= RZV2N_FIP_OFFSET)
#error "RZV2N_SPIROM_DDR_CFG_OFFSET + RZV2N_DDR_CFG_SIZE_MAX must be less than RZV2N_FIP_OFFSET"
#endif

#else

#if ((RZV2N_FIP_OFFSET + RZV2N_FIP_SIZE_MAX) > RZV2N_M33_FW_OFFSET)
#error "RZV2N_FIP_OFFSET + RZV2N_FIP_SIZE_MAX must be less than RZV2N_M33_FW_OFFSET"
#endif
...
#define RZV2N_UART_BAUDRATE			UL(115200)
...
#define RZ_SOC_AUTH_API_BASE        RZV2N_AUTH_API_BASE
#endif
