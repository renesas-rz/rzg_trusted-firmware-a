...
//KTG: TODO: These pin definitions need updating once they are known
static PFC_REGS pfc_mux_reg_tbl[PFC_MUX_TBL_NUM] = {
	/* P18(sd0) */
	{
		...
		{ PFC_OFF, (uintptr_t)PFC_IOLH22, 0x00000101 },		/* IOLH */
		{ PFC_OFF, (uintptr_t)PFC_PUPD22, 0x00000000 },		/* PUPD */
		{ PFC_OFF, (uintptr_t)PFC_SR23,   0x00000101 },		/* SR */
	...
	/* P19(sd1) */
	{
		...
		{ PFC_OFF, (uintptr_t)PFC_IOLH23, 0x00000101 },		/* IOLH */
		{ PFC_OFF, (uintptr_t)PFC_PUPD23, 0x00000000 },		/* PUPD */
		{ PFC_OFF, (uintptr_t)PFC_SR23,   0x00000101 },		/* SR */
		{ PFC_OFF, (uintptr_t)NULL,       0 }				/* IEN */
	},
	...
	/* P39(scif0) */
	{
		...
		{ PFC_OFF, (uintptr_t)PFC_IOLH23, 0x00010101 },		/* IOLH */
		{ PFC_OFF, (uintptr_t)PFC_PUPD23, 0x00000000 },		/* PUPD */
		{ PFC_OFF, (uintptr_t)PFC_SR23,   0x00010101 },		/* SR */
		{ PFC_OFF, (uintptr_t)NULL,       0 }				/* IEN */
	}
};
//KTG: TODO: These pin definitions need updating once they are known
static PFC_REGS  pfc_qspi_reg_tbl[PFC_QSPI_TBL_NUM] = {
	/* QSPI0 */
	{
		...
		{ PFC_ON,  (uintptr_t)PFC_IOLH0A, 0x02020202 },		/* IOLH */
		{ PFC_ON,  (uintptr_t)PFC_PUPD0A, 0x00000000 },		/* PUPD */
		{ PFC_ON,  (uintptr_t)PFC_SR0A,   0x01010101 },		/* SR */
		{ PFC_OFF, (uintptr_t)NULL,       0 }				/* IEN */
	},
	/* QSPI1 */
	{
		{ PFC_OFF, (uintptr_t)NULL,       0 },				/* PMC */
		{ PFC_OFF, (uintptr_t)NULL,       0 },				/* PFC */
		{ PFC_ON,  (uintptr_t)PFC_IOLH0B, 0x02020202 },		/* IOLH */
		{ PFC_ON,  (uintptr_t)PFC_PUPD0B, 0x00000000 },		/* PUPD */
		{ PFC_ON,  (uintptr_t)PFC_SR0B,   0x01010101 },		/* SR */
		{ PFC_OFF, (uintptr_t)NULL,       0 }				/* IEN */
	},
	/* QSPIn */
	{
		{ PFC_OFF, (uintptr_t)NULL,       0 },				/* PMC */
		{ PFC_OFF, (uintptr_t)NULL,       0 },				/* PFC */
		{ PFC_ON,  (uintptr_t)PFC_IOLH0C, 0x00020202 },		/* IOLH */
		{ PFC_ON,  (uintptr_t)PFC_PUPD0C, 0x00000000 },		/* PUPD */
		{ PFC_ON,  (uintptr_t)PFC_SR0C,   0x00010000 },		/* SR */
		{ PFC_OFF, (uintptr_t)NULL,       0 }				/* IEN */
	}
};
...
static PFC_REGS  pfc_sd_reg_tbl[PFC_SD_TBL_NUM] = {
	/* SD0_CLK */
	{
		...
		{ PFC_ON,  (uintptr_t)PFC_IOLH06, 0x00020202 },		/* IOLH */
		{ PFC_ON,  (uintptr_t)PFC_PUPD06, 0x00000000 },		/* PUPD */
		{ PFC_ON,  (uintptr_t)PFC_SR06,   0x00010101 },		/* SR */
		{ PFC_ON,  (uintptr_t)PFC_IEN2B,  0x00000100 }		/* IEN */
	},
	/* SD0_DATA */
	{
		{ PFC_OFF, (uintptr_t)NULL,       0 },				/* PMC */
		{ PFC_OFF, (uintptr_t)NULL,       0 },				/* PFC */
		{ PFC_ON,  (uintptr_t)PFC_IOLH07, 0x02020202 },		/* IOLH */
		{ PFC_ON,  (uintptr_t)PFC_PUPD07, 0x00000000 },		/* PUPD */
		{ PFC_ON,  (uintptr_t)PFC_SR07,   0x01010101 },		/* SR */
		{ PFC_ON,  (uintptr_t)PFC_IEN2B,  0x01010101 }		/* IEN */
	},
	/* SD1_CLK */
	{
		{ PFC_ON,  (uintptr_t)PFC_PMC23,  0x0003 },			/* PMC */
		{ PFC_ON,  (uintptr_t)PFC_PFC23,  0x00000003 },		/* PFC */
		{ PFC_ON,  (uintptr_t)PFC_IOLH08, 0x00000202 },		/* IOLH */
		{ PFC_ON,  (uintptr_t)PFC_PUPD08, 0x00000000 },		/* PUPD */
		{ PFC_ON,  (uintptr_t)PFC_SR08,   0x00000101 },		/* SR */
		{ PFC_ON,  (uintptr_t)PFC_IEN2B,  0x00000100 }		/* IEN */
	},
	/* SD1_DATA */
	{
		{ PFC_OFF, (uintptr_t)NULL,       0 },				/* PMC */
		{ PFC_OFF, (uintptr_t)NULL,       0 },				/* PFC */
		{ PFC_ON,  (uintptr_t)PFC_IOLH09, 0x02020202 },		/* IOLH */
		{ PFC_ON,  (uintptr_t)PFC_PUPD09, 0x00000000 },		/* PUPD */
		{ PFC_ON,  (uintptr_t)PFC_SR09,   0x01010101 },		/* SR */
		{ PFC_ON,  (uintptr_t)PFC_IEN2B,  0x01010101 }		/* IEN */
	}
};
...
static void pfc_sd_setup(void)
{
	...
	// TOD0: KTG: Is there a SD Voltage option?
