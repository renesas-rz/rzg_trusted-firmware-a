...
void cpg_reset_wdt1(void)
{
	...
	mmio_write_32(RZV2H_ICU_ERINTA55CLR(0), 0x10000000);
}
...
static void cpg_wdtrst_sel_setup(void)
{
	...
	mmio_write_32(RZV2H_ICU_ERINTM33CLR(0), 0x10000000);
	mmio_write_32(RZV2H_ICU_ERINTA55CLR(0), 0x10000000);

	ca33_w01 = mmio_read_32(RZV2H_ICU_ERINTM33CTL(0));
	ca33_w23 = mmio_read_32(RZV2H_ICU_ERINTM33CTL(1));
	ca55_w01 = mmio_read_32(RZV2H_ICU_ERINTA55CTL(0));
	ca55_w23 = mmio_read_32(RZV2H_ICU_ERINTA55CTL(1));
	...
	if ((ca33_w01 == 0x40000000) || (ca33_w01 == 0x80000000) ||
		...
		mmio_write_32(RZV2H_ICU_ERINTM33CLR(0), 0xF0000000);
	}
	...
	if ((ca55_w01 == 0x40000000) || (ca55_w01 == 0x80000000) ||
		...
		mmio_write_32(RZV2H_ICU_ERINTA55CLR(0), 0xF0000000);
	}
