...
#define CPG_PLL_STBY_RESETB					(1 << 0)
#define CPG_PLL_STBY_SSC_EN					(1 << 2)
#define CPG_PLL_STBY_SSC_MODE				(1 << 4)
#define CPG_PLL_STBY_RESETB_WEN				(1 << 16)
#define CPG_PLL_STBY_SSC_EN_WEN				(1 << 18)
#define CPG_PLL_STBY_SSC_MODE_WEN			(1 << 20)

#define CPG_PLL_CLK1_DIV_P					(1 << 0)
#define CPG_PLL_CLK1_DIV_M					(1 << 6)
#define CPG_PLL_CLK1_DIV_K					(1 << 16)

#define CPG_PLL_CLK2_DIV_S					(1 << 0)
#define CPG_PLL_CLK2_MRR					(1 << 8)
#define CPG_PLL_CLK2_MFR					(1 << 16)

#define CPG_PLL_CLK3_ICP					(1 << 0)
#define CPG_PLL_CLK3_BYPASS					(1 << 3)
#define CPG_PLL_CLK3_AFC_ENB				(1 << 4)
#define CPG_PLL_CLK3_EXTAFC					(1 << 5)
#define CPG_PLL_CLK3_FEED_EN				(1 << 10)
#define CPG_PLL_CLK3_FSEL					(1 << 11)
#define CPG_PLL_CLK3_AFCINIT_SEL			(1 << 12)
#define CPG_PLL_CLK3_PBIAS_CTRL_EN			(1 << 13)
#define CPG_PLL_CLK3_PBIAS_CTRL				(1 << 14)
#define CPG_PLL_CLK3_AFC_SEL				(1 << 15)
#define CPG_PLL_CLK3_ICP0_WEN				(1 << 16)
#define CPG_PLL_CLK3_ICP1_WEN				(1 << 17)
#define CPG_PLL_CLK3_ICP2_WEN				(1 << 18)
#define CPG_PLL_CLK3_BYPASS_WEN				(1 << 19)
#define CPG_PLL_CLK3_AFC_ENB_WEN			(1 << 20)
#define CPG_PLL_CLK3_EXTAFC0_WEN			(1 << 21)
#define CPG_PLL_CLK3_EXTAFC1_WEN			(1 << 22)
#define CPG_PLL_CLK3_EXTAFC2_WEN			(1 << 23)
#define CPG_PLL_CLK3_EXTAFC3_WEN			(1 << 24)
#define CPG_PLL_CLK3_EXTAFC4_WEN			(1 << 25)
#define CPG_PLL_CLK3_FEED_EN_WEN			(1 << 26)
#define CPG_PLL_CLK3_FSEL_WEN				(1 << 27)
#define CPG_PLL_CLK3_AFCINIT_SEL_WEN		(1 << 28)
#define CPG_PLL_CLK3_PBIAS_CTRL_EN_WEN		(1 << 29)
#define CPG_PLL_CLK3_PBIAS_CTR_WEN			(1 << 30)
#define CPG_PLL_CLK3_AFC_SEL_WEN			(1 << 31)

#define CPG_PLL_MON_PLLn_RESETB				(1 << 0)
#define CPG_PLL_MON_PLLn_LOCK				(1 << 4)

#define CPG_BUS_1_MSTOP_TMZ400_ACPU_SRAM	(1 << 12)
#define CPG_BUS_1_MSTOP_TZC400_PCIe1		(1 << 13)
#define CPG_BUS_1_MSTOP_TZC400_ACPU_RCPU	(1 << 14)
#define CPG_BUS_1_MSTOP_TZC400_PCIe0		(1 << 15)

#define CPG_BUS_2_MSTOP_A_DMAC				(1 << 5)
#define CPG_BUS_2_MSTOP_TZC400_DDR0_0		(1 << 6)
#define CPG_BUS_2_MSTOP_TZC400_DDR0_1		(1 << 7)
#define CPG_BUS_2_MSTOP_TZC400_DDR1_0		(1 << 8)
#define CPG_BUS_2_MSTOP_TZC400_DDR1_1		(1 << 9)
#define CPG_BUS_2_MSTOP_TZC400_R8			(1 << 10)
#define CPG_BUS_2_MSTOP_TZC400_A55			(1 << 11)
#define CPG_BUS_2_MSTOP_TZC400_PCIe			(1 << 12)
#define CPG_BUS_2_MSTOP_ACPU_OSTM0			(1 << 13)
#define CPG_BUS_2_MSTOP_ACPU_OSTM1			(1 << 14)
#define CPG_BUS_2_MSTOP_TSU1				(1 << 15)

#define CPG_BUS_3_MSTOP_SYC					(1 << 0)
#define CPG_BUS_3_MSTOP_ACPU_SRAM			(1 << 1)
#define CPG_BUS_3_MSTOP_ACPU_DMAC0			(1 << 2)
#define CPG_BUS_3_MSTOP_ACPU_DMAC1			(1 << 3)
#define CPG_BUS_3_MSTOP_GPU					(1 << 4)
#define CPG_BUS_3_MSTOP_GIC_GIC				(1 << 5)
#define CPG_BUS_3_MSTOP_ADC					(1 << 9)
#define CPG_BUS_3_MSTOP_RTC					(1 << 11)
#define CPG_BUS_3_MSTOP_SCIF				(1 << 14)

#define CPG_BUS_4_MSTOP_XSPI_TZC400			(1 << 5)
#define CPG_BUS_4_MSTOP_GPI0				(1 << 7)
#define CPG_BUS_4_MSTOP_CGP					(1 << 8)
#define CPG_BUS_4_MSTOP_SYSC				(1 << 9)
#define CPG_BUS_4_MSTOP_TZC400_M33			(1 << 12)
#define CPG_BUS_4_MSTOP_TZC400_XSPI			(1 << 13)
#define CPG_BUS_4_MSTOP_MHU					(1 << 14)

#define CPG_BUS_5_MSTOP_TSU0				(1 << 2)
#define CPG_BUS_5_MSTOP_MCPU_SRAM0			(1 << 3)
#define CPG_BUS_5_MSTOP_MCPU_SRAM1			(1 << 4)
#define CPG_BUS_5_MSTOP_XSPI				(1 << 5)
#define CPG_BUS_5_MSTOP_MCPU_DMAC			(1 << 9)
#define CPG_BUS_5_MSTOP_MCPU_OSTM0			(1 << 10)
#define CPG_BUS_5_MSTOP_MCPU_OSTM1			(1 << 11)

#define CPG_BUS_6_MSTOP_POEG_A_GPT0			(1 << 3)
#define CPG_BUS_6_MSTOP_POEG_B_GPT0			(1 << 4)
#define CPG_BUS_6_MSTOP_POEG_C_GPT0			(1 << 5)
#define CPG_BUS_6_MSTOP_POEG_D_GPT0			(1 << 6)
#define CPG_BUS_6_MSTOP_POEG_A_GPT1			(1 << 7)
#define CPG_BUS_6_MSTOP_POEG_B_GPT1			(1 << 8)
#define CPG_BUS_6_MSTOP_POEG_C_GPT1			(1 << 9)
#define CPG_BUS_6_MSTOP_POEG_D_GPT1			(1 << 10)

#define CPG_BUS_7_MSTOP_USB2_HOST0			(1 << 7)
#define CPG_BUS_7_MSTOP_USB2_HOST1			(1 << 8)
#define CPG_BUS_7_MSTOP_USB2_FUNCTION		(1 << 9)
#define CPG_BUS_7_MSTOP_USB2_PHY0			(1 << 10)
#define CPG_BUS_7_MSTOP_USB2_PHY1			(1 << 11)
#define CPG_BUS_7_MSTOP_USB3_HOST0			(1 << 12)
#define CPG_BUS_7_MSTOP_USB3_HOST1			(1 << 13)
#define CPG_BUS_7_MSTOP_USB3_PHY0			(1 << 14)
#define CPG_BUS_7_MSTOP_USB3_PHY1			(1 << 15)

#define CPG_BUS_8_MSTOP_PCIe_PHY			(1 << 0)
#define CPG_BUS_8_MSTOP_SD0					(1 << 2)
#define CPG_BUS_8_MSTOP_SD1					(1 << 3)
#define CPG_BUS_8_MSTOP_SD2					(1 << 4)
#define CPG_BUS_8_MSTOP_GBETH0				(1 << 5)
#define CPG_BUS_8_MSTOP_GBETH1				(1 << 6)

#define CPG_BUS_9_MSTOP_DSI_LINK			(1 << 14)
#define CPG_BUS_9_MSTOP_DSI_DPHY			(1 << 15)

#define CPG_BUS_10_MSTOP_LCDC_DU			(1 << 1)
#define CPG_BUS_10_MSTOP_LCDC_FCPVD			(1 << 2)
#define CPG_BUS_10_MSTOP_LCDC_VSPD			(1 << 3)
#define CPG_BUS_10_MSTOP_CAN_FD				(1 << 14)
#define CPG_BUS_10_MSTOP_CAN_I3C			(1 << 15)
