...
#define RZV2H_XSPI_MEMORY_MAP_BASE	UL(0x20000000)
...
#define RZV2H_BL2_END_OFFSET		(0x00040000)					/* This value is not checked/enforced anywhwere */
#define RZV2H_FIP_SIZE_MAX			UL(0x001DFFFF)
...
#define RZV2H_EMMC_BL2_LOAD_OFFSET	UL(0x00000400)
#define RZV2H_EMMC_FIP_BASE			(RZV2H_EMMC_BL2_LOAD_OFFSET + RZV2H_BL2_END_OFFSET)
#define RZV2H_EMMC_FIP_SIZE			RZV2H_FIP_SIZE_MAX

#define RZV2H_SD_BL2_LOAD_OFFSET	UL(0x00001000)
#define RZV2H_SD_FIP_BASE			(RZV2H_SD_BL2_LOAD_OFFSET + RZV2H_BL2_END_OFFSET)
