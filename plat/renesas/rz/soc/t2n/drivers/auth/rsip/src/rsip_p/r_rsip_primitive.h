...
void r_rsip_func084_r1(void);
void r_rsip_func085_r1(void);
void r_rsip_func086_r1(uint32_t ARG1[]);
void r_rsip_func087_r1(uint32_t ARG1[]);
...
void r_rsip_func220(uint32_t ARG1[], uint32_t ARG2, uint32_t ARG3[]);
void r_rsip_func221(uint32_t ARG1[], uint32_t ARG2);
...
void r_rsip_func400_r1(uint32_t ARG1[]);
...
/* SHA */
rsip_ret_t r_rsip_p70f(const uint32_t InData_Msg[],
					   uint32_t MAX_CNT,
					   uint32_t OutData_MsgDigest[]);

rsip_ret_t r_rsip_p70i(const uint32_t InData_HashType[],
