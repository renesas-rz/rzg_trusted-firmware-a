...
static const struct {
	...
	{MSTACCCTL0,  0xFFFF0F0FU, 0xEEEE0E0EU},
	{MSTACCCTL1,  0x000F000BU, 0x000E000AU},
	{MSTACCCTL2,  0xFFFFFFFFU, 0xEEEEEEEEU},
	{MSTACCCTL3,  0x0000000BU, 0x0000000AU},
	/* Slave Access Control Register */
	{SLVACCCTL0,  0xC0FFC3FFU, 0x00000000U},
	...
	{SLVACCCTL5,  0xFF0F0F33U, 0x00000002U},
	{SLVACCCTL6,  0xFF3FFCFFU, 0x00000000U},
	{SLVACCCTL7,  0xFFCC3FFFU, 0x0AC00000U},
	{SLVACCCTL8,  0x0F3FFCF3U, 0x0000A8A0U},
	{SLVACCCTL9,  0x3FFF3F03U, 0x00000000U},
};
...
{
	const arm_tzc_regions_info_t ddr_port1_tzc_regions[] = {
	...
	const arm_tzc_regions_info_t ddr_port0_tzc_regions[] = {
		{
			/* Default Region 0: Complete access */
			.base = 0,	/* Not Used by Region 0 */
			.end  = 0,	/* Not Used by Region 0 */
	...
	/* DDR Port 1 */
	plat_tzc400_setup(RZT2N_TZC400_0, &ddr_port1_tzc_regions[0]);
	/* DDR Port 0 */
	plat_tzc400_setup(RZT2N_TZC400_2, &ddr_port0_tzc_regions[0]);
}
...
static void plat_tzc_xspi_setup(void)
{
	const arm_tzc_regions_info_t xspi_tzc_regions[] = {
...

		{
			...
			.base = RZT2N_XSPI0_MEMORY_MAP_BASE,
			.end  = RZT2N_XSPI0_MEMORY_MAP_BASE + RZT2N_XSPI_MEMORY_MAP_SIZE - 1ULL,
			.sec_attr = PLAT_TZC_SEC_ATTR_REG_UNUSED_VAL,
...

		{
			...
			.base = RZT2N_XSPI1_MEMORY_MAP_BASE,
			.end  = RZT2N_XSPI1_MEMORY_MAP_BASE + RZT2N_XSPI_MEMORY_MAP_SIZE - 1ULL,
			.sec_attr = PLAT_TZC_SEC_ATTR_REG_UNUSED_VAL,
			.nsaid_permissions = PLAT_TZC_REGION_ACCESS_NS_PRIV
		},
	...
	plat_tzc400_setup(RZT2N_TZC400_5, &xspi_tzc_regions[0]);
}
...
static void plat_tzc_pci_setup(void)
{
	...
	plat_tzc400_setup(RZT2N_TZC400_1, &pci_tzc_regions[0]);
}
...
static void plat_tzc_r52_tcm_setup(void)
{
	...
	plat_tzc400_setup(RZT2N_TZC400_6, &r52_tzc_regions[0]);
}
...
static void plat_tzc_bsc_setup(void)
{
	...
	plat_tzc400_setup(RZT2N_TZC400_4, &bsc_tzc_regions[0]);
}
#endif
...
static void bl31_security_setup(void)
{
	...
	plat_tzc400_setup(RZT2N_TZC400_3, &sys_ram_tzc_regions[0]);
}
#endif
