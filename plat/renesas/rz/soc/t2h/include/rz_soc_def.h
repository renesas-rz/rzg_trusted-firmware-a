...
#define RZT2H_GICD_SIZE						UL(0x000200000)

#define RZT2H_SYSC_SIZE						UL(0x001000000)
...
#define RZT2H_BL2_SIZE_MAX					(BL2_LIMIT - BL2_BASE)		/* This value is not checked/enforced anywhwere */
#define RZT2H_FIP_SIZE_MAX					UL(0x001DFFFF)

#define RZT2H_XSPI0_FIP_BASE				(RZT2H_XSPI0_MEMORY_MAP_BASE + RZT2H_BL2_SIZE_MAX)
#define RZT2H_XSPI0_FIP_SIZE				(RZT2H_XSPI1_MEMORY_MAP_BASE - RZT2H_XSPI0_FIP_BASE)

#define RZT2H_XSPI1_FIP_BASE				(RZT2H_XSPI1_MEMORY_MAP_BASE + RZT2H_BL2_SIZE_MAX)
#define RZT2H_XSPI1_FIP_SIZE				RZT2H_XSPI0_FIP_SIZE	/* Both XSPI memory mapped regions are the same size */
...
#define RZT2H_SYC_INCK_HZ					UL(24000000)
...
#define CPG_BASE							RZT2H_CPG_BASE
