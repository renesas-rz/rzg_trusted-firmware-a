...
void bl31_plat_arch_setup(void)
{
	...
	const mmap_region_t rzt2h_mmap[] = {
		MAP_REGION_FLAT(RZT2H_SYS_RAM_BASE, RZT2H_SYS_RAM_SIZE,
				MT_MEMORY | MT_RW | MT_SECURE),
		...
		MAP_REGION_FLAT(RZT2H_R_BUS_SAFETY_DEVICE_BASE, RZT2H_R_BUS_SAFETY_DEVICE_SIZE,
				MT_DEVICE | MT_RW | MT_SECURE),
		MAP_REGION_FLAT(RZT2H_LLPP_DEVICE_BASE, RZT2H_LLPP_DEVICE_SIZE,
				MT_DEVICE | MT_RW | MT_SECURE),
		...
		MAP_REGION_FLAT(RZT2H_GICD_BASE, RZT2H_GICD_SIZE,
				MT_DEVICE | MT_RW | MT_SECURE),
		MAP_REGION_FLAT(RZT2H_DDR_BASE, RZT2H_DDR_SIZE,
				MT_MEMORY | MT_RW | MT_SECURE),
		MAP_REGION_FLAT(RZT2H_DDR_MIRROR_0_BASE, RZT2H_DDR_MIRROR_SIZE,
				MT_MEMORY | MT_RW | MT_SECURE),
		MAP_REGION_FLAT(RZT2H_DDR_MIRROR_1_BASE, RZT2H_DDR_MIRROR_SIZE,
				MT_MEMORY | MT_RW | MT_SECURE),
		MAP_REGION_FLAT(RZT2H_PCIe0_BASE, RZT2H_PCIe_SIZE,
				MT_MEMORY | MT_RW | MT_SECURE),
		MAP_REGION_FLAT(RZT2H_PCIe1_BASE, RZT2H_PCIe_SIZE,
				MT_MEMORY | MT_RW | MT_SECURE),
		MAP_REGION_FLAT(RZT2H_PCIe0_MIRROR_BASE, RZT2H_PCIe_MIRROR_SIZE,
				MT_MEMORY | MT_RW | MT_SECURE),
		MAP_REGION_FLAT(RZT2H_PCIe1_MIRROR_BASE, RZT2H_PCIe_MIRROR_SIZE,
				MT_MEMORY | MT_RW | MT_SECURE),
		{0}
	};
