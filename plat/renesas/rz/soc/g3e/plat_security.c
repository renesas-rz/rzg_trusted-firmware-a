...
static const struct {
	...
	/* SYS_MSTACCCTL2 is reserved */
	{SYS_MSTACCCTL3,  0x00BBBBBBU, 0x00AAAAAAU},
	{SYS_MSTACCCTL4,  0x000000BBU, 0x000000AAU},
	{SYS_MSTACCCTL5,  0x00BBBBBBU, 0x00AAAAAAU},
	{SYS_MSTACCCTL6,  0x0000BBBBU, 0x0000AAAAU},
	{SYS_MSTACCCTL7,  0x000000BBU, 0x000000AAU},
	{SYS_MSTACCCTL8,  0x00000303U, 0x00000202U},
	/* SYS_MSTACCCTL9 to SYS_MSTACCCTL11 is reserved */
	{SYS_MSTACCCTL12, 0x000000BBU, 0x000000AAU},
	{SYS_MSTACCCTL13, 0x0000BBBBU, 0x0000AAAAU},
	{SYS_MSTACCCTL14, 0x000000BBU, 0x000000AAU},
	{SYS_MSTACCCTL15, 0x000000BBU, 0x000000AAU},
	/* SYS_MSTACCCTL16 to SYS_MSTACCCTL18 is reserved */
	{SYS_MSTACCCTL19, 0x000000BBU, 0x000000AAU},
	...
	/* SYS_SLVACCCTL15 is reserved */
	{SYS_SLVACCCTL16, 0x0000000CU, 0x00000000U},
	/* SYS_SLVACCCTL17 and SYS_SLVACCCTL18 is reserved */
	{SYS_SLVACCCTL19, 0x00000003U, 0x00000000U},
	{SYS_SLVACCCTL20, 0x00000003U, 0x00000000U},
	{SYS_SLVACCCTL21, 0x0000000FU, 0x00000000U},
	/* SYS_SLVACCCTL21 to SYS_SLVACCCTL31 is reserved */
	{SYS_SLVACCCTL32, 0x0000000FU, 0x00000000U},
	/* SYS_SLVACCCTL33 and SYS_SLVACCCTL34 is reserved */
	...
	{SYS_SLVACCCTL40, 0x0000FF33U, 0x00000000U},
	{SYS_SLVACCCTL41, 0x0000000FU, 0x00000000U},
	{SYS_SLVACCCTL43, 0x00000033U, 0x00000000U},
	{SYS_SLVACCCTL44, 0x00000003U, 0x00000000U},
	/* SYS_SLVACCCTL45 and SYS_SLVACCCTL46 is reserved */
	...
	/* SYS_SLVACCCTL54 is reserved */
	{SYS_SLVACCCTL55, 0x00000003U, 0x00000000U},
	{SYS_SLVACCCTL56, 0x00000003U, 0x00000000U},
	/* SYS_SLVACCCTL57 not changed from default */
	/* SYS_SLVACCCTL58 to SYS_SLVACCCTL63 not listed*/
	...
	/* SYS_SLVACCCTL69 to SYS_SLVACCCTL79 is reserved */
	{SYS_SLVACCCTL80, 0x00000003U, 0x00000000U},
	{SYS_SLVACCCTL81, 0x00000003U, 0x00000000U},
	/* SYS_SLVACCCTL82 to SYS_SLVACCCTL86 is reserved */
	{SYS_SLVACCCTL87, 0x00000003U, 0x00000000U},
	/* SYS_SLVACCCTL88 is reserved */
...
static void plat_tzc_ddr_setup(void)
{
	...
	plat_tzc400_setup(RZG3E_TZC400_DDR_1_BASE, &ddr0_1_tzc_regions[0]);
}
