...
/*
 * CPG_LP_CA55_CTL2 and CPG_LP_CA55_CTL3 bit definitions
 */
#define COREPREQ0_MASK			(1UL << 0)
#define COREPREQ1_MASK			(1UL << 16)
#define COREPREQ2_MASK			(1UL << 0)
#define COREPREQ3_MASK			(1UL << 16)

#define COREPREQ0_STOP			(0UL << 0)
#define COREPREQ1_STOP			(0UL << 16)
#define COREPREQ2_STOP			(0UL << 0)
#define COREPREQ3_STOP			(0UL << 16)

#define COREPREQ0_OUT			(1UL << 0)
#define COREPREQ1_OUT			(1UL << 16)
#define COREPREQ2_OUT			(1UL << 0)
#define COREPREQ3_OUT			(1UL << 16)

#define COREPSTATE0_MASK		(0b111111 << 1)
#define COREPSTATE1_MASK		(0b111111 << 17)
#define COREPSTATE2_MASK		(0b111111 << 1)
#define COREPSTATE3_MASK		(0b111111 << 17)

#define COREPSTATE0_ON			(0b001000 << 1)
#define COREPSTATE1_ON			(0b001000 << 17)
#define COREPSTATE2_ON			(0b001000 << 1)
#define COREPSTATE3_ON			(0b001000 << 17)

#define COREPDENY0_MASK			(1UL << 7)
#define COREPDENY1_MASK			(1UL << 23)
#define COREPDENY2_MASK			(1UL << 7)
#define COREPDENY3_MASK			(1UL << 23)

#define COREPDENY0_ACCEPT		(0UL << 7)
#define COREPDENY1_ACCEPT		(0UL << 23)
#define COREPDENY2_ACCEPT		(0UL << 7)
#define COREPDENY3_ACCEPT		(0UL << 23)

#define COREPDENY0_REJECT		(1UL << 7)
#define COREPDENY1_REJECT		(1UL << 23)
#define COREPDENY2_REJECT		(1UL << 7)
#define COREPDENY3_REJECT		(1UL << 23)

#define COREACCEPT0_MASK		(1UL << 8)
#define COREACCEPT1_MASK		(1UL << 24)
#define COREACCEPT2_MASK		(1UL << 8)
#define COREACCEPT3_MASK		(1UL << 24)

#define COREACCEPT0_ACCEPT		(1UL << 8)
#define COREACCEPT1_ACCEPT		(1UL << 24)
#define COREACCEPT2_ACCEPT		(1UL << 8)
#define COREACCEPT3_ACCEPT		(1UL << 24)

#define COREACCEPT0_REJECT		(0UL << 8)
#define COREACCEPT1_REJECT		(0UL << 24)
#define COREACCEPT2_REJECT		(0UL << 8)
#define COREACCEPT3_REJECT		(0UL << 24)
