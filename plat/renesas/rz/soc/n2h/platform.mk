...
pkg:
	...
	python3 ./tools/renesas/rzn2h_boot_param/parameter_block_generator.py --output=./build/n2h/$(BUILD_TYPE)/bp_xspi0.bin --cache_flag=1 --loader_addr=0x40000200 --loader_size=$$bl2_filesize --dest_addr=0x10001000 --pll0_ssc_ctr_v=0x00010000 --bootcpu_flg=1  --xspi_cssctl_v=0x07FFFFFF ; \
	python3 ./tools/renesas/rzn2h_boot_param/parameter_block_generator.py --output=./build/n2h/$(BUILD_TYPE)/bp_xspi1.bin --cache_flag=1 --loader_addr=0x50000200 --loader_size=$$bl2_filesize --dest_addr=0x10001000 --pll0_ssc_ctr_v=0x00010000 --bootcpu_flg=1  --xspi_cssctl_v=0x07FFFFFF ; \
	python3 ./tools/renesas/rzn2h_boot_param/parameter_block_generator.py --output=./build/n2h/$(BUILD_TYPE)/bp_emmc.bin  --cache_flag=1 --loader_addr=0x00000400 --loader_size=$$bl2_filesize --dest_addr=0x10001000 --pll0_ssc_ctr_v=0x00010000 --bootcpu_flg=1 ; \
	python3 ./tools/renesas/rzn2h_boot_param/parameter_block_generator.py --output=./build/n2h/$(BUILD_TYPE)/bp_esd.bin   --cache_flag=1 --loader_addr=0x00001000 --loader_size=$$bl2_filesize --dest_addr=0x10001000 --pll0_ssc_ctr_v=0x00010000 --bootcpu_flg=1
	...
	cat ./build/n2h/$(BUILD_TYPE)/bp_esd.bin ./build/n2h/$(BUILD_TYPE)/bl2.bin > ./build/n2h/$(BUILD_TYPE)/bl2_bp_esd.bin
	...
	tar zcvf ../tf-a-n2h.tar.gz $(shell pwd)
