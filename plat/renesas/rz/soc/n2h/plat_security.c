...
static void plat_tzc_syssram_setup(void)
{
	...
	plat_tzc400_setup(RZN2H_TZC400_5, &msram_tzc_regions[0]);
}
...
static void plat_tzc_ddr_setup(void)
{
	...
	/* DDR A-BUS */
	plat_tzc400_setup(RZN2H_TZC400_0, &ddr_a_bus_tzc_regions[0]);
	plat_tzc400_setup(RZN2H_TZC400_1, &ddr_a_bus_tzc_regions[0]);
	/* DDR R-BUS */
	plat_tzc400_setup(RZN2H_TZC400_3, &ddr_r_bus_tzc_regions[0]);
	plat_tzc400_setup(RZN2H_TZC400_4, &ddr_r_bus_tzc_regions[0]);
}
...
static void plat_tzc_xspi_setup(void)
{
	const arm_tzc_regions_info_t xspi_tzc_regions[] = {
...

		{
			...
			.base = RZN2H_XSPI0_MEMORY_MAP_BASE,
			.end  = RZN2H_XSPI0_MEMORY_MAP_BASE + RZN2H_XSPI_MEMORY_MAP_SIZE - 1ULL,
			.sec_attr = TZC_REGION_S_RDWR,
...

		{
			...
			.base = RZN2H_XSPI1_MEMORY_MAP_BASE,
			.end  = RZN2H_XSPI1_MEMORY_MAP_BASE + RZN2H_XSPI_MEMORY_MAP_SIZE - 1ULL,
			.sec_attr = TZC_REGION_S_RDWR,
			.nsaid_permissions = PLAT_TZC_REGION_ACCESS_NS_PRIV
		},
	...
	plat_tzc400_setup(RZN2H_TZC400_7, &xspi_tzc_regions[0]);
}
...
static void plat_tzc_pci_setup(void)
{
	...
	plat_tzc400_setup(RZN2H_TZC400_2, &pci_tzc_regions[0]);
}
...
static void plat_tzc_r52_tcm_setup(void)
{
	...
	plat_tzc400_setup(RZN2H_TZC400_8, &r52_tzc_regions[0]);
}
...
static void plat_tzc_bsc_setup(void)
{
	...
	plat_tzc400_setup(RZN2H_TZC400_6, &bsc_tzc_regions[0]);
}
