...
static void decode_streaming_message_lpddr4(uint32_t codede_message_hex, uint16_t *args_list)
{
	...
	case 0x000c0001:
		...
		break;
	case 0x000d0001:
		INFO("PMU0: MaxRdLat non consistent DtsmLoThldXingInd 0x%x\n", args_list[0]);
		break;
	case 0x000e0003:
	...
	case 0x00510001:
		...
		break;
	case 0x00520000:
		INFO("PMU: Error: Both 2t timing mode and ddr4 geardown mode specified in the messageblock's PhyCfg and MR3 fields. Only one can be enabled\n");
		break;
	case 0x00530003:
	...
	case 0x04060002:
		...
		break;
	case 0x04070001:
		INFO("PMU: Error: acsm_set_cmd to non existent instruction address %d\n", args_list[0]);
		break;
	case 0x04080001:
...
static void decode_streaming_message_lpddr4_2d(uint32_t codede_message_hex, uint16_t *args_list)
{
	...
	case 0x00960000:
		...
		break;
	case 0x00970002:
		INFO("PMU0: targeting CsX = %d and CsY = %d\n", args_list[0], args_list[1]);
		break;
	case 0x00980001:
		INFO("PMU1:prbsGenCtl:%x\n", args_list[0]);
		break;
