...
uint32_t sys_get_platform_core_count(void)
{
	...
	switch (part_number) {
	case OTP_PN_RZN2H_QUAD_SEC_R9A09G077M48GBG:
	case OTP_PN_RZN2H_QUAD_R9A09G077M44GBG: {
		core_count = 4U;
	}
	break;

	case OTP_PN_RZN2H_DUAL_SEC_R9A09G077M28GBG:
	case OTP_PN_RZN2H_DUAL_R9A09G077M24GBG: {
		core_count = 2U;
	}
	break;

	case OTP_PN_RZN2H_SINGLE_SEC_R9A09G077M08GBG:
	case OTP_PN_RZN2H_SINGLE_R9A09G077M04GBG: {
		core_count = 1U;
	}
	break;
