...
/* PLATFORM_CORE_COUNT can be 1, 2 or 4 on RZ/N2H so expected needs to
...
#define BL2_LIMIT				UL(0x101FD000 - 0x1000)	 /* 0x1000 = PARAMS_SIZE */

/*******************************************************************************
 * BL31 specific defines.
 ******************************************************************************/
#define BL31_BASE				UL(0x200000000)
