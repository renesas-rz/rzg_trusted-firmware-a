...
/* AP shared secure SRAM0 0x00020000 - 0x0005FFFF */
#define PLAT_AP_TZC_PROT_SRAM0_BASE		(0x00020000)
#define PLAT_AP_TZC_PROT_SRAM0_SIZE		(0x00040000)
#define PLAT_AP_TZC_PROT_SRAM0_END		\
	(PLAT_AP_TZC_PROT_SRAM0_BASE + PLAT_AP_TZC_PROT_SRAM0_SIZE - 1)

/* AP shared secure SRAM1 0x00060000 - 0x0009FFFF */
#define PLAT_AP_TZC_PROT_SRAM1_BASE		(0x00060000)
#define PLAT_AP_TZC_PROT_SRAM1_SIZE		(0x00040000)
#define PLAT_AP_TZC_PROT_SRAM1_END		\
	(PLAT_AP_TZC_PROT_SRAM1_BASE + PLAT_AP_TZC_PROT_SRAM1_SIZE - 1)

/* AP shared secure SRAM2 0x000A00000 - 0x000DFFFF */
#define PLAT_AP_TZC_PROT_SRAM2_BASE		(0x000A00000)
#define PLAT_AP_TZC_PROT_SRAM2_SIZE		(0x00040000)
