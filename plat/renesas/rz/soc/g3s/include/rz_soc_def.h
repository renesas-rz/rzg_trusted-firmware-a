...
#define RZG3S_TZC400_ASRAM_2_BASE		UL(0x11220000)
...
#define RZG3S_SRAM_SIZE					(RZG3S_MSRAM_SIZE + RZG3S_ASRAM_SIZE + 0x2000)
#define RZG3S_DDR0_SIZE					ULL(0x40000000)

#define RZG3S_NS_DRAM_BASE				ULL(0x48000000)

/* 0x60000 = 384 KB This value is not checked/enforced anywhere */
...
#define RZG3S_SPIROM_DDR_CFG_BASE		(RZG3S_SPIROM_M33_FW_BASE + RZG3S_M33_FW_SIZE)
#define RZG3S_EMMC_DDR_CFG_BASE			(RZG3S_EMMC_M33_FW_BASE + RZG3S_M33_FW_SIZE)
#define RZG3S_SD_DDR_CFG_BASE			(RZG3S_SD_M33_FW_BASE + RZG3S_M33_FW_SIZE)

#if ((RZG3S_BL2_SIZE_MAX + RZG3S_FIP_SIZE_MAX) > RZG3S_M33_FW_OFFSET)
#error "RZG3S_BL2_SIZE_MAX + RZG3S_FIP_SIZE_MAX must be less than RZG3S_M33_FW_OFFSET"
#endif

#define RZG3S_SYC_INCK_HZ				U(24000000)
#define RZG3S_UART_INCK_HZ				U(100000000)
#define RZG3S_UART_BAUDRATE				U(115200)
