...
uint32_t sddev_get_clockdiv(int32_t sd_port, int32_t clock)
{
	...
	switch (clock) {
	case SD_CLK_50MHZ:
		div = SD_DIV_1;		/* 33.33MHz/1 = 33.33MHz   */
		break;
	case SD_CLK_25MHZ:
	case SD_CLK_20MHZ:
		div = SD_DIV_2;		/* 33.33MHz/2 = 16.66MHz   */
		break;
	case SD_CLK_10MHZ:
		div = SD_DIV_4;		/* 33.33MHz/4 = 8.33MHz	*/
		break;
	case SD_CLK_5MHZ:
		div = SD_DIV_8;		/* 33.33MHz/8 = 4.16MHz	*/
		break;
	case SD_CLK_1MHZ:
		div = SD_DIV_64;	   /* 33.33MHz/64 = 520.7kHz  */
		break;
	case SD_CLK_400KHZ:
		div = SD_DIV_128;	  /* 33.33MHz/128 = 260.3kHz */
		break;
	default:
		div = SD_DIV_128;	  /* 33.33MHz/128 = 260.3kHz */
		break;
