...
/*
 * MMC Clock Frequency
 * (133MHz/4) * 1/x = output clock
 */
#define MMC_CLK_OFF			0UL		/* Clock output is disabled                                  */
#define MMC_400KHZ			128UL	/* (133MHz/4) * 1/128 = 260 KHz                              */
#define MMC_20MHZ			2UL		/* (133MHz/4) * 1/2   = 16.63 MHz Normal speed mode          */
#define MMC_26MHZ			2UL		/* (133MHz/4) * 1/2   = 16.63 MHz High speed mode 26Mhz      */
#define MMC_52MHZ			1UL		/* (133MHz/4) * 1/1   = 33.25 MHz High speed mode 52Mhz      */
#define MMC_100MHZ			1UL		/* (133MHz/4) * 1/1   = 33.25 MHz                            */
#define MMC_200MHZ			1UL		/* (133MHz/4) * 1/1   = 33.25 MHz                            */
