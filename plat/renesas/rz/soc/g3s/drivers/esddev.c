 ...
 * Return Value : SD_DIV_1    :complete setting to devide by 1
 *                SD_DIV_2    :complete setting to devide by 2
 ...
 *                SD_DIV_512  :complete setting to devide by 512
 *********************************************************************************************************************/
uint32_t esddev_get_clockdiv(int32_t clock)
{
	...
	do {
		switch (clock) {
		case SD_CLK_50MHz:
			uiret_clkdiv = SD_DIV_1;    /* 33.33 MHz */
			break;
		case SD_CLK_25MHz:
		case SD_CLK_20MHz:
			uiret_clkdiv = SD_DIV_2;    /* 16.63 MHz */
			break;
		case SD_CLK_10MHz:
			uiret_clkdiv = SD_DIV_4;    /* 8.33 MHz */
			break;
		case SD_CLK_5MHz:
			uiret_clkdiv = SD_DIV_32;   /* 4.16 MHz */
			break;
		case SD_CLK_1MHz:
			uiret_clkdiv = SD_DIV_64;   /* 521 KHz */
			break;
		case SD_CLK_400kHz:
			uiret_clkdiv = SD_DIV_128;  /* 260 KHz */
			break;
		default:
