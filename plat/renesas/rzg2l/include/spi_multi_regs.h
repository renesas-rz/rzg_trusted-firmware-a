...
#define SSLDR_SLNDL_1QSPIn					(0 << 0)
#define SSLDR_SLNDL_2QSPIn					(1 << 0)
#define SSLDR_SLNDL_3QSPIn					(2 << 0)
#define SSLDR_SLNDL_4QSPIn					(3 << 0)
#define SSLDR_SLNDL_5QSPIn					(4 << 0)
#define SSLDR_SLNDL_6QSPIn					(5 << 0)
#define SSLDR_SLNDL_7QSPIn					(6 << 0)
#define SSLDR_SLNDL_8QSPIn					(7 << 0)
#define SSLDR_SPNDL_1QSPIn					(0 << 0)
#define SSLDR_SPNDL_2QSPIn					(1 << 0)
#define SSLDR_SPNDL_3QSPIn					(2 << 0)
#define SSLDR_SPNDL_4QSPIn					(3 << 0)
#define SSLDR_SPNDL_5QSPIn					(4 << 0)
#define SSLDR_SPNDL_6QSPIn					(5 << 0)
#define SSLDR_SPNDL_7QSPIn					(6 << 0)
#define SSLDR_SPNDL_8QSPIn					(7 << 0)
...
#define DRDMCR_DMCYC_2CYCLE					(1 << 0)
#define DRDMCR_DMCYC_3CYCLE					(2 << 0)
#define DRDMCR_DMCYC_4CYCLE					(3 << 0)
#define DRDMCR_DMCYC_5CYCLE					(4 << 0)
#define DRDMCR_DMCYC_6CYCLE					(5 << 0)
#define DRDMCR_DMCYC_7CYCLE					(6 << 0)
#define DRDMCR_DMCYC_8CYCLE					(7 << 0)
#define DRDMCR_DMCYC_9CYCLE					(8 << 0)
#define DRDMCR_DMCYC_10CYCLE				(9 << 0)
#define DRDMCR_DMCYC_11CYCLE				(10 << 0)
#define DRDMCR_DMCYC_12CYCLE				(11 << 0)
#define DRDMCR_DMCYC_13CYCLE				(12 << 0)
#define DRDMCR_DMCYC_14CYCLE				(13 << 0)
#define DRDMCR_DMCYC_15CYCLE				(14 << 0)
#define DRDMCR_DMCYC_16CYCLE				(15 << 0)
#define DRDMCR_DMCYC_17CYCLE				(16 << 0)
#define DRDMCR_DMCYC_18CYCLE				(17 << 0)
#define DRDMCR_DMCYC_19CYCLE				(18 << 0)
#define DRDMCR_DMCYC_20CYCLE				(19 << 0)
...
#define SMDMCR_DMCYC_2CYCLE					(1 << 0)
#define SMDMCR_DMCYC_3CYCLE					(2 << 0)
#define SMDMCR_DMCYC_4CYCLE					(3 << 0)
#define SMDMCR_DMCYC_5CYCLE					(4 << 0)
#define SMDMCR_DMCYC_6CYCLE					(5 << 0)
#define SMDMCR_DMCYC_7CYCLE					(6 << 0)
#define SMDMCR_DMCYC_8CYCLE					(7 << 0)
#define SMDMCR_DMCYC_9CYCLE					(8 << 0)
#define SMDMCR_DMCYC_10CYCLE				(9 << 0)
#define SMDMCR_DMCYC_11CYCLE				(10 << 0)
#define SMDMCR_DMCYC_12CYCLE				(11 << 0)
#define SMDMCR_DMCYC_13CYCLE				(12 << 0)
#define SMDMCR_DMCYC_14CYCLE				(13 << 0)
#define SMDMCR_DMCYC_15CYCLE				(14 << 0)
#define SMDMCR_DMCYC_16CYCLE				(15 << 0)
#define SMDMCR_DMCYC_17CYCLE				(16 << 0)
#define SMDMCR_DMCYC_18CYCLE				(17 << 0)
#define SMDMCR_DMCYC_19CYCLE				(18 << 0)
#define SMDMCR_DMCYC_20CYCLE				(19 << 0)
