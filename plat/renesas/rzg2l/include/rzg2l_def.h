...
#define FLASH_MEMORY_SIZE		U(0x10000000)	/* hyper flash */
#define FLASH_TRANS_SIZE_UNIT		U(0x00000100)
#define DEVICE_RZG2L_BASE		U(0xE6000000)
#define DEVICE_RZG2L_SIZE		U(0x00300000)
#define DEVICE_RZG2L_BASE2		U(0xE6360000)
#define DEVICE_RZG2L_SIZE2		U(0x19CA0000)
#define DEVICE_SRAM_BASE		U(0x00010000)
...
#define DRAM_LIMIT			ULL(0x000000023FFFFFFF)
...
#define	DRAM_40BIT_SIZE			ULL(0x2000000000)
...
#define	RZG2L_BL31_CRASH_BASE		U(0x4403F000)
#define	RZG2L_BL31_CRASH_SIZE		U(0x00001000)
/* Entrypoint mailboxes */
#define MBOX_BASE			RZG2L_SHARED_MEM_BASE
#define MBOX_SIZE			0x200
/* Base address where parameters to BL31 are stored */
#define PARAMS_BASE			(MBOX_BASE + MBOX_SIZE)
#define BOOT_KIND_BASE			(RZG2L_SHARED_MEM_BASE + \
					RZG2L_SHARED_MEM_SIZE - 0x100)
/* The number of regions like RO(code), coherent and data required by
 * different BL stages which need to be mapped in the MMU */
#if USE_COHERENT_MEM
#define RZG2L_BL_REGIONS			(3)
#else
#define RZG2L_BL_REGIONS			(2)
#endif
/* The RZG2L_MAX_MMAP_REGIONS depend on the number of entries in rzg2l_mmap[]
 * defined for each BL stage in rzg2l_common.c. */
#if IMAGE_BL2
#define RZG2L_MMAP_ENTRIES		(9)
#endif
#if IMAGE_BL31
#define RZG2L_MMAP_ENTRIES		(9)
#endif
...
/* BL31 */
#define	RZG2L_LOG_RES_SIZE		(512/8)
#define	RZG2L_LOG_HEADER_SIZE		(16)
#define	RZG2L_LOG_OTHER_SIZE		(RZG2L_LOG_HEADER_SIZE + \
					RZG2L_LOG_RES_SIZE)
#define	RZG2L_BL31_LOG_MAX		(RZG2L_BL31_LOG_SIZE - \
					RZG2L_LOG_OTHER_SIZE)
#define	RZG2L_CRASH_STACK		RZG2L_BL31_CRASH_BASE
...
#define	RZG2L_CCI_BASE				CCI500_BASE
/* GIC */
#define RZG2L_GICC_BASE			U(0xF1020000)
#define RZG2L_GICH_BASE			U(0xF1040000)
#define RZG2L_GICV_BASE			U(0xF1060000)
...
/* Timer control */
#define	RZG2L_CNTC_BASE		U(0xE6080000)
/* Reset */
#define	RZG2L_CPGWPR		U(0xE6150900)	/* CPG write protect    */
#define	RZG2L_MODEMR		U(0xE6160060)	/* Mode pin             */
#define	RZG2L_CA57RESCNT		U(0xE6160040)	/* Reset control A57    */
#define	RZG2L_CA53RESCNT		U(0xE6160044)	/* Reset control A53    */
#define	RZG2L_SRESCR		U(0xE6160110)	/* Soft Power On Reset  */
#define	RZG2L_CA53WUPCR		U(0xE6151010)	/* Wake-up control A53  */
#define	RZG2L_CA57WUPCR		U(0xE6152010)	/* Wake-up control A57  */
#define	RZG2L_CA53PSTR		U(0xE6151040)	/* Power status A53     */
#define	RZG2L_CA57PSTR		U(0xE6152040)	/* Power status A57     */
#define	RZG2L_CA53CPU0CR		U(0xE6151100)	/* CPU control  A53     */
#define	RZG2L_CA57CPU0CR		U(0xE6152100)	/* CPU control  A57     */
#define	RZG2L_CA53CPUCMCR	U(0xE6151184)	/* Common power A53     */
#define	RZG2L_CA57CPUCMCR	U(0xE6152184)	/* Common power A57     */
#define	RZG2L_WUPMSKCA57		U(0xE6180014)	/* Wake-up mask A57     */
#define	RZG2L_WUPMSKCA53		U(0xE6180018)	/* Wake-up mask A53     */
/* SYSC	*/
#define	RZG2L_PWRSR3		U(0xE6180140)	/* Power stat A53-SCU   */
#define	RZG2L_PWRSR5		U(0xE61801C0)	/* Power stat A57-SCU   */
#define	RZG2L_SYSCIER		U(0xE618000C)	/* Interrupt enable     */
#define	RZG2L_SYSCIMR		U(0xE6180010)	/* Interrupt mask       */
#define	RZG2L_SYSCSR		U(0xE6180000)	/* SYSC status          */
#define	RZG2L_PWRONCR3		U(0xE618014C)	/* Power resume A53-SCU */
#define	RZG2L_PWRONCR5		U(0xE61801CC)	/* Power resume A57-SCU */
#define	RZG2L_PWROFFCR3		U(0xE6180144)	/* Power shutof A53-SCU */
#define	RZG2L_PWROFFCR5		U(0xE61801C4)	/* Power shutof A57-SCU */
#define	RZG2L_PWRER3		U(0xE6180154)	/* shutoff/resume error */
#define	RZG2L_PWRER5		U(0xE61801D4)	/* shutoff/resume error */
#define	RZG2L_SYSCISR		U(0xE6180004)	/* Interrupt status     */
#define	RZG2L_SYSCISCR		U(0xE6180008)	/* Interrupt stat clear */
/* Product register */
#define	RZG2L_PRR			U(0xFFF00044)
#define RZG2L_M3_CUT_VER11		U(0x00000010)	/* M3 Ver.1.1/Ver.1.2 */
#define RZG2L_MAJOR_MASK			U(0x000000F0)
#define RZG2L_MINOR_MASK			U(0x0000000F)
#define PRR_PRODUCT_SHIFT		U(8)
#define RZG2L_MAJOR_SHIFT		U(4)
#define RZG2L_MINOR_SHIFT		U(0)
#define RZG2L_MAJOR_OFFSET		U(1)
#define RZG2L_M3_MINOR_OFFSET		U(2)
...
#define RZG2L_CPU_MASK_CA57		U(0x80000000)
#define RZG2L_CPU_MASK_CA53		U(0x04000000)
#define RZG2L_CPU_HAVE_CA57		U(0x00000000)
#define RZG2L_CPU_HAVE_CA53		U(0x00000000)
#define RZG2L_SSCG_MASK			U(0x1000)	/* MD12 */
#define RZG2L_SSCG_ENABLE		U(0x1000)
/* MD pin information */
...
#define ARM_SYS_CNTCTL_BASE		RZG2L_CNTC_BASE
...
#define RZG2L_COLD_BOOT			(0x00U)
#define RZG2L_WARM_BOOT			(0x01U)
#if PMIC_ROHM_BD9571 && RZG2L_SYSTEM_RESET_KEEPON_DDR
