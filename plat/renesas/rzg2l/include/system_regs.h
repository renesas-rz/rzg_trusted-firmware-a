#ifndef _SYSTEM_REGS_H_
#define _SYSTEM_REGS_H_

#define	SYSTEM_BASE							(0x11000000)

#define	SYS_MSTACCCTL0						(SYSTEM_BASE + 0x00000000)
#define	SYS_MSTACCCTL1						(SYSTEM_BASE + 0x00000004)
#define	SYS_MSTACCCTL2						(SYSTEM_BASE + 0x00000008)
#define	SYS_MSTACCCTL3						(SYSTEM_BASE + 0x0000000C)
#define	SYS_MSTACCCTL4						(SYSTEM_BASE + 0x00000010)
#define	SYS_MSTACCCTL5						(SYSTEM_BASE + 0x00000014)
#define	SYS_SLVACCCTL0						(SYSTEM_BASE + 0x00000100)
#define	SYS_SLVACCCTL1						(SYSTEM_BASE + 0x00000104)
#define	SYS_SLVACCCTL2						(SYSTEM_BASE + 0x00000108)
#define	SYS_SLVACCCTL3						(SYSTEM_BASE + 0x0000010C)
#define	SYS_SLVACCCTL4						(SYSTEM_BASE + 0x00000110)
#define	SYS_SLVACCCTL5						(SYSTEM_BASE + 0x00000114)
#define	SYS_SLVACCCTL6						(SYSTEM_BASE + 0x00000118)
#define	SYS_SLVACCCTL7						(SYSTEM_BASE + 0x0000011C)
#define	SYS_SLVACCCTL8						(SYSTEM_BASE + 0x00000120)
#define	SYS_SLVACCCTL9						(SYSTEM_BASE + 0x00000124)
#define	SYS_SLVACCCTL10						(SYSTEM_BASE + 0x00000128)
#define	SYS_SLVACCCTL11						(SYSTEM_BASE + 0x0000012C)
#define	SYS_SLVACCCTL12						(SYSTEM_BASE + 0x00000130)
#define	SYS_SLVACCCTL13						(SYSTEM_BASE + 0x00000134)
#define	SYS_SLVACCCTL14						(SYSTEM_BASE + 0x00000138)
#define	SYS_SLVACCCTL15						(SYSTEM_BASE + 0x0000013C)
#define	SYS_RAM0_ECC						(SYSTEM_BASE + 0x00000200)
#define	SYS_RAM0_EN							(SYSTEM_BASE + 0x00000204)
#define	SYS_RAM0_TEST						(SYSTEM_BASE + 0x00000208)
#define	SYS_RAM0_MON						(SYSTEM_BASE + 0x0000020C)
#define	SYS_RAM1_ECC						(SYSTEM_BASE + 0x00000210)
#define	SYS_RAM1_EN							(SYSTEM_BASE + 0x00000214)
#define	SYS_RAM1_TEST						(SYSTEM_BASE + 0x00000218)
#define	SYS_RAM1_MON						(SYSTEM_BASE + 0x0000021C)
#define	SYS_WDT0_CTRL						(SYSTEM_BASE + 0x00000220)
#define	SYS_WDT1_CTRL						(SYSTEM_BASE + 0x00000230)
#define	SYS_WDT2_CTRL						(SYSTEM_BASE + 0x00000240)
#define	SYS_WDT3_CTRL						(SYSTEM_BASE + 0x00000250)
#define	SYS_GPU_COHE						(SYSTEM_BASE + 0x00000300)
#define	SYS_GPU_STRP						(SYSTEM_BASE + 0x00000304)
#define	SYS_GPU_TEXT						(SYSTEM_BASE + 0x00000308)
#define	SYS_H264_CFG0						(SYSTEM_BASE + 0x00000310)
#define	SYS_H264_CFG1						(SYSTEM_BASE + 0x00000314)
#define	SYS_H264_CFG2						(SYSTEM_BASE + 0x00000318)
#define	SYS_H264_MON						(SYSTEM_BASE + 0x0000031C)
#define	SYS_H264_BSTOP						(SYSTEM_BASE + 0x00000320)
#define	SYS_GETH0_CFG						(SYSTEM_BASE + 0x00000330)
#define	SYS_GETH1_CFG						(SYSTEM_BASE + 0x00000340)
#define	SYS_I2C0_CFG						(SYSTEM_BASE + 0x00000400)
#define	SYS_I2C1_CFG						(SYSTEM_BASE + 0x00000410)
#define	SYS_I2C2_CFG						(SYSTEM_BASE + 0x00000420)
#define	SYS_I2C3_CFG						(SYSTEM_BASE + 0x00000430)
#define	SYS_CANFD_CFG						(SYSTEM_BASE + 0x00000440)
#define	SYS_SCIF0_CFG						(SYSTEM_BASE + 0x00000450)
#define	SYS_SCIF1_CFG						(SYSTEM_BASE + 0x00000460)
#define	SYS_SCIF2_CFG						(SYSTEM_BASE + 0x00000470)
#define	SYS_SCIF3_CFG						(SYSTEM_BASE + 0x00000480)
#define	SYS_SCIF4_CFG						(SYSTEM_BASE + 0x00000490)
#define	SYS_SCI0_CFG						(SYSTEM_BASE + 0x000004A0)
#define	SYS_SCI1_CFG						(SYSTEM_BASE + 0x000004B0)
#define	SYS_CM33_STAT						(SYSTEM_BASE + 0x00000800)
#define	SYS_CM33_CFG0						(SYSTEM_BASE + 0x00000804)
#define	SYS_CM33_CFG1						(SYSTEM_BASE + 0x00000808)
#define	SYS_CM33_CFG2						(SYSTEM_BASE + 0x0000080C)
#define	SYS_CM33_CFG3						(SYSTEM_BASE + 0x00000810)
#define	SYS_CM33_LOCK						(SYSTEM_BASE + 0x00000814)
#define	SYS_CM33_CTL						(SYSTEM_BASE + 0x00000818)
#define	SYS_CA55_CFG_AArch0					(SYSTEM_BASE + 0x00000840)
#define	SYS_CA55_CFG_AArch1					(SYSTEM_BASE + 0x00000844)
#define	SYS_CA55_CFG_Endian0				(SYSTEM_BASE + 0x00000848)
#define	SYS_CA55_CFG_Endian1				(SYSTEM_BASE + 0x0000084C)
#define	SYS_CA55_CFG_Thumb0					(SYSTEM_BASE + 0x00000850)
#define	SYS_CA55_CFG_Thumb1					(SYSTEM_BASE + 0x00000854)
#define	SYS_CA55_CFG_RVAL0					(SYSTEM_BASE + 0x00000858)
#define	SYS_CA55_CFG_RVAH0					(SYSTEM_BASE + 0x0000085C)
#define	SYS_CA55_CFG_RVAL1					(SYSTEM_BASE + 0x00000860)
#define	SYS_CA55_CFG_RVAH1					(SYSTEM_BASE + 0x00000864)
#define	SYS_CA55_CFG_VA0					(SYSTEM_BASE + 0x00000868)
#define	SYS_CA55_CFG_VA1					(SYSTEM_BASE + 0x0000086C)
#define	SYS_BBG_CTRL_ENABLE					(SYSTEM_BASE + 0x00000900)
#define	SYS_BBG_CTRL						(SYSTEM_BASE + 0x00000904)
#define	SYS_BBG_CTRL_MON					(SYSTEM_BASE + 0x00000908)
#define	SYS_BBG_OFFSET0						(SYSTEM_BASE + 0x0000090C)
#define	SYS_BBG_OFFSET1						(SYSTEM_BASE + 0x00000910)
#define	SYS_BBG_OFFSET2						(SYSTEM_BASE + 0x00000914)
#define	SYS_BBG_OFFSET3						(SYSTEM_BASE + 0x00000918)
#define	SYS_BBG_OFFSET4						(SYSTEM_BASE + 0x0000091C)
#define	SYS_BBG_OFFSET5						(SYSTEM_BASE + 0x00000920)
#define	SYS_BBG_OFFSET6						(SYSTEM_BASE + 0x00000924)
#define	SYS_BBG_OFFSET7						(SYSTEM_BASE + 0x00000928)
#define	SYS_BBG_OFFSET_CTRL					(SYSTEM_BASE + 0x00000930)
#define	SYS_BBG_PFREQ_MON					(SYSTEM_BASE + 0x00000934)
#define	SYS_BBG_NFREQ_MON					(SYSTEM_BASE + 0x00000938)
#define	SYS_BBG_TEMP_MON					(SYSTEM_BASE + 0x0000093C)
#define	SYS_BBG_VOLT_MON					(SYSTEM_BASE + 0x00000940)
#define	SYS_LSI_MODE						(SYSTEM_BASE + 0x00000A00)
#define	SYS_LSI_DEVID						(SYSTEM_BASE + 0x00000A04)
#define	SYS_LSI_PRR							(SYSTEM_BASE + 0x00000A08)
#define	SYS_LSI_OTPSECEN					(SYSTEM_BASE + 0x00000A0C)
#define	SYS_LSI_OTPSECMODE					(SYSTEM_BASE + 0x00000A10)
#define	SYS_LSI_OTPJAM						(SYSTEM_BASE + 0x00000A14)
#define	SYS_LSI_OTPCORE						(SYSTEM_BASE + 0x00000A18)
#define	SYS_LSI_OTPPOC						(SYSTEM_BASE + 0x00000A20)
#define	SYS_JAUTH_JUDGE						(SYSTEM_BASE + 0x00000B00)
#define	SYS_AOF0							(SYSTEM_BASE + 0x00000C00)
#define	SYS_AOF1							(SYSTEM_BASE + 0x00000C04)
#define	SYS_AOF2							(SYSTEM_BASE + 0x00000C08)
#define	SYS_AOF3							(SYSTEM_BASE + 0x00000C0C)
#define	SYS_AOF4							(SYSTEM_BASE + 0x00000C10)
#define	SYS_AOF5							(SYSTEM_BASE + 0x00000C14)
#define	SYS_AOF6							(SYSTEM_BASE + 0x00000C18)
#define	SYS_AOF7							(SYSTEM_BASE + 0x00000C1C)
#define	SYS_AOF8							(SYSTEM_BASE + 0x00000C20)
#define	SYS_LP_CTL0							(SYSTEM_BASE + 0x00000D00)
#define	SYS_LP_CTL1							(SYSTEM_BASE + 0x00000D04)
#define	SYS_LP_CTL2							(SYSTEM_BASE + 0x00000D08)
#define	SYS_LP_CTL3							(SYSTEM_BASE + 0x00000D0C)
#define	SYS_LP_CTL4							(SYSTEM_BASE + 0x00000D10)
#define	SYS_LP_CTL5							(SYSTEM_BASE + 0x00000D14)
#define	SYS_LP_CTL6							(SYSTEM_BASE + 0x00000D18)
#define	SYS_LP_CTL7							(SYSTEM_BASE + 0x00000D1C)
#define	SYS_LP_CTL8							(SYSTEM_BASE + 0x00000D20)
#define	SYS_LP_CM33CTL0						(SYSTEM_BASE + 0x00000D24)
#define	SYS_LP_CM33CTL1						(SYSTEM_BASE + 0x00000D28)
#define	SYS_LP_CM33CTL2						(SYSTEM_BASE + 0x00000D2C)
#define	SYS_LP_CM33CPG						(SYSTEM_BASE + 0x00000D30)
#define	SYS_LP_CA55_CTL0					(SYSTEM_BASE + 0x00000D34)
#define	SYS_LP_CA55CK_CTL1					(SYSTEM_BASE + 0x00000D38)
#define	SYS_LP_CA55CK_CTL2					(SYSTEM_BASE + 0x00000D3C)
#define	SYS_LP_CA55CK_CTL3					(SYSTEM_BASE + 0x00000D40)
#define	SYS_LP_CA55CPGC0					(SYSTEM_BASE + 0x00000D44)
#define	SYS_LP_CA55CPGC1					(SYSTEM_BASE + 0x00000D48)
#define	SYS_LP_GPU_CTL						(SYSTEM_BASE + 0x00000D50)
#define	SYS_GPREG_0							(SYSTEM_BASE + 0x00000E00)
#define	SYS_GPREG_1							(SYSTEM_BASE + 0x00000E04)
#define	SYS_GPREG_2							(SYSTEM_BASE + 0x00000E08)
#define	SYS_GPREG_3							(SYSTEM_BASE + 0x00000E0C)
#define	SYS_RESREG_0						(SYSTEM_BASE + 0x00000E10)
#define	SYS_RESREG_1						(SYSTEM_BASE + 0x00000E14)
#define	SYS_RESREG_2						(SYSTEM_BASE + 0x00000E18)
#define	SYS_RESREG_3						(SYSTEM_BASE + 0x00000E1C)
