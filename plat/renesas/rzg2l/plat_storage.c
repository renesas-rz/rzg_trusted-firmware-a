...
static uintptr_t rzg2l_dev_handle;
...
static int32_t open_rzg2l(const uintptr_t spec);
...
static int32_t open_rzg2l(const uintptr_t spec)
{
	return io_dev_init(rzg2l_dev_handle, boot_io_drv_id);
}

static int32_t open_fipdrv(const uintptr_t spec)
{
	return io_dev_init(fip_dev_handle, boot_io_drv_id);
}
