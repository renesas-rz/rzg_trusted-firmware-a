...
static PFC_REGS  pfc_qspi_reg_tbl[PFC_QSPI_TBL_NUM] = {
	/* QSPI0 */
	{
		...
		{ PFC_OFF, (uintptr_t)PFC_IOLH0A, 0x0000010101010101 },	/* IOLH */
		{ PFC_OFF, (uintptr_t)PFC_PUPD0A, 0x0000000000000000 },	/* PUPD */
		{ PFC_OFF, (uintptr_t)PFC_SR0A,   0x0000010101010101 },	/* SR */
		{ PFC_OFF, (uintptr_t)NULL,       0 }						/* IEN */
	},
	/* QSPI1 */
	{
		{ PFC_OFF, (uintptr_t)NULL,       0 },						/* PMC */
		{ PFC_OFF, (uintptr_t)NULL,       0 },						/* PFC */
		{ PFC_OFF, (uintptr_t)PFC_IOLH0B, 0x0000010101010101 },	/* IOLH */
		{ PFC_OFF, (uintptr_t)PFC_PUPD0B, 0x0000000000000000 },	/* PUPD */
		{ PFC_OFF, (uintptr_t)PFC_SR0B,   0x0000010101010101 },	/* SR */
		{ PFC_OFF, (uintptr_t)NULL,       0 }						/* IEN */
	},
	/* QSPIn */
	{
